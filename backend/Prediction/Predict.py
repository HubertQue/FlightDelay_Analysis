...
def json_to_row(data_json):
    ...
    mapping_file_path = 'Prediction/airport_data.json'
...
def predict_delay(data_json={}):
    (data_test, flag) = json_to_row(data_json)
    if flag:
        prediction, probability = evaluate_model(data_test, model_type='mlp',
                                                 encoder_path='Prediction/models/mlp_os_cls_encoder.joblib',
                                                 scaler_path='Prediction/models/mlp_os_cls_scaler.joblib',
                                                 model_path='Prediction/models/mlp_os_cls.joblib')
