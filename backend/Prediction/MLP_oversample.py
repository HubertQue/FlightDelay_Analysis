...
# 创建 MLP 模型
mlp = MLPClassifier(hidden_layer_sizes=hidden_layer_size, batch_size=batch_size, learning_rate_init=learning_rate, max_iter=1, shuffle=shuffle, verbose=True, warm_start=True, random_state=random_seed)
